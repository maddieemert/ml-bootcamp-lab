...
# Do private colleges produce more undergraduate awards per 100 students than public colleges?
...
# a) College Completion Dataset
# - Question: Do private colleges produce more undergraduate awards per 100 students than public colleges?
...
#   - awards_per_value already represents target variable
...
# - create target variable if needed
#   - salary already represents target variable
# - calculate the prevalence of the target variable
# - create the necessary data partitions (Train,Tune,Test)
...
# a) College Completion Dataset
# The dataset seems to be suitable to answer my question, as it contains the minimum necessary variables- control (public/private), and a numeric measure of undergraduate award production (awards_per_value). My first instinct is that private colleges may produce more awards per 100 students due to their smaller size and increased resources, and there are also several areas of caution to note. This includes potential outliers, impact of cohort sizes, missing data, differences in program types, and lack of context.
# b) Job Placement Dataset
